...
This project is for educational and portfolio purposes only — see [LICENSE.md](LICENSE.md) for full terms (non-commercial, no redistribution/App Store publishing, attribution required).
